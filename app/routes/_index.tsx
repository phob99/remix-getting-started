  ...
  return (
    <div className="flex items-center justify-center h-screen">
      <div className="flex flex-col items-center gap-16">
        ...
        <nav className="flex flex-col items-center justify-center gap-4 p-6 border border-gray-200 rounded-3xl dark:border-gray-700">
...
const resources = [
  ...
  {
    href: "https://discord.com/invite/uc9H5YKjXv",
    text: "Join Genezio Discord",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
